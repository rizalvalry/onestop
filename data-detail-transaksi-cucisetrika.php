            <div class="table-responsive">
                <table id="table-cucisetrika" class="table table-striped table-bordered" >
                  <thead>
                    <tr>
                ...
                <tr>
                    ...
                    <button data-id="<?php echo $hasil['No_Order']; ?>" data-ids="<?php echo $hasil['Id_Pakaian']; ?>" data-idl="<?php echo $hasil['Id_Laundry']; ?>" class="btn btn-danger btn-sm hapus_data_cucisetrika"> <i class="fa fa-trash"></i> Hapus </button>
                    </td>
                </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#table-cucisetrika').DataTable();
    } );



    $(document).on('click', '.hapus_data_cucisetrika', function(){
