...
<div class="content-wrapper">
  ...
  <h3>Form Cek Transaksi Laundry</h3>
  <hr>
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="No_Order" value="<?php echo $result['nama']; ?>" readonly>
                ...
                <div class="form-group">
                  <label>Diskon</label>
                  <input type="text" id="diskon" class="form-control" name="diskon" placeholder="Diskon" value="<?php echo $hasil['diskon']; ?>" readonly>
                </div>
                <div class="form-group">
                  <label>DP</label>
          ...
          <?php
            $sql = mysqli_query($conn, "SELECT skala.nama as skala, transaksi.Tgl_Terima, transaksi.Tgl_Ambil, transaksi.No_Order, transaksi.payment 
            from 
            transaksi 
          ...
          <div class="form-group">
          <label>Jenis Pembayaran di awal</label>
          <input type="text"  class="form-control" value="<?php echo $hasil['payment']; ?>" readonly>
          </div>
