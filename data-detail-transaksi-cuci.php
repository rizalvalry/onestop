                ...
                <table id="table" class="table table-striped table-bordered" >
                  ...
                  <tbody>
                    ...
                    include "./include/koneksi.php";
                      ...
                      $no_o = $no + 1;
                      $i = 0 + 1;
                      $detail = mysqli_query($conn, "SELECT p.Jenis_Pakaian, l.Jenis_Laundry, detail_transaksi.No_Order, detail_transaksi.Id_Pakaian, detail_transaksi.Jumlah_pakaian, detail_transaksi.Id_Laundry FROM detail_transaksi join pakaian p on detail_transaksi.Id_Pakaian = p.Id_Pakaian join laundry l on detail_transaksi.Id_Laundry = l.Id_Laundry Where No_Order = $no_o AND Jenis_Laundry = 'Cuci' AND admin_id=$admin_id");
